...
@Service
public class UsuarioServicioOld implements UserDetailsService {

    @Autowired
    private UsuarioRepositorio usuarioRepositorio;

    @Transactional
    public Usuario create(String username, String password, String password2, String mail, String ciudad, String nombre, String apellido, String dni, Date fechaDeNacimiento) throws ErrorServicio {
    ...
    @Transactional
    public Usuario editUser(Usuario usuario) throws ErrorServicio {
        try {
            return usuarioRepositorio.save(usuario);
        } catch(Exception e) {
            throw new ErrorServicio("Hubo un error al modificar el usuario");
        }
    }
    ...
    @Transactional
    public void removeById(String id) throws ErrorServicio {
